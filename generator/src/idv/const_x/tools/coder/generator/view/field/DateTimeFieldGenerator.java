...
public class DateTimeFieldGenerator extends SimpleTypeFieldGenerator{
	...
	public void init(ViewContext context, Field field) {
		...
		create.append("   			<td><input class='easyui-datetimebox' type='text' name='")
		...
		update.append("   			<td><input class='easyui-datetimebox' type='text' name='")
		.append(field.getName()).append("' data-options=\"").append(field.isNullable() ? "":"required:true,")
