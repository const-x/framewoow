...
public class MysqlPermissionGenerator {

	public String generator(Context context) {

		
		String  insert = "INSERT INTO security_module ( `description`, `name`, `priority`, `url`, `parent_id`, `sn`, `type`, `creater`, `createtime`, `modifyer`, `modifytime`) VALUES (";
		...
		pid = "( select t2.id from security_module t2 where t2.sn = '"  +context.getComponent().toLowerCase()+"' )"; 
